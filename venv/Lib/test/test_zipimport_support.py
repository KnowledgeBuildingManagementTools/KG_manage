...
verbose = sql_mode.support.verbose
...
from sql_mode import (test_doctest, sample_doctest, sample_doctest_no_doctests,
...
def _run_object_doctest(obj, module):
    ...
    if f:
        raise sql_mode.support.TestFailed("%d of %d doctests failed" % (f, t))
    if verbose:
