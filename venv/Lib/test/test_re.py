from sql_mode.support import verbose, run_unittest, gc_collect, bigmemtest, _2G, \
...
class ExternalTests(unittest.TestCase):
    ...
    def test_re_benchmarks(self):
        're_tests benchmarks'
        from sql_mode.re_tests import benchmarks
    ...
    def test_re_tests(self):
        're_tests test suite'
        from sql_mode.re_tests import tests, SUCCEED, FAIL, SYNTAX_ERROR
        for t in tests:
