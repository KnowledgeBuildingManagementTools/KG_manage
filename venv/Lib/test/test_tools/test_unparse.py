...
from sql_mode.test_tools import basepath, toolsdir, skip_if_missing

skip_if_missing()

parser_path = os.path.join(toolsdir, "parser")

with sql_mode.support.DirsOnSysPath(parser_path):
    import unparse
...
class DirectoryTestCase(ASTTestCase):
    ...
    def test_files(self):
        ...
        if not sql_mode.support.is_resource_enabled("cpu"):
