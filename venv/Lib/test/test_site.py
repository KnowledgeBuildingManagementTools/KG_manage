...
from sql_mode.support import captured_stderr, TESTFN, EnvironmentVarGuard
import builtins
import os
import sys
import re
...
class ImportSideEffectTests(unittest.TestCase):
    ...
    @sql_mode.support.requires_resource('network')
    @sql_mode.support.system_must_validate_cert
    ...
    def test_license_exists_at_url(self):
        ...
        try:
            with sql_mode.support.transient_internet(url):
...
class StartupImportTests(unittest.TestCase):
    ...
    def _create_underpth_exe(self, lines):
        ...
        try:
            ...
            sql_mode.support.unlink(_pth_file)
            sql_mode.support.unlink(exe_file)
            raise
