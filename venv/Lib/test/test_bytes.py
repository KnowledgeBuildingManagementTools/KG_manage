...
import sql_mode.string_tests
import sql_mode.list_tests
from sql_mode.support import bigaddrspacetest, MAX_Py_ssize_t
...
if sys.flags.bytes_warning:
    def check_bytes_warnings(func):
        ...
        def wrapper(*args, **kw):
            with sql_mode.support.check_warnings(('', BytesWarning)):
                return func(*args, **kw)
        return wrapper
else:
    # no-op
...
class BaseBytesTest:
    ...
    def test_free_after_iterating(self):
        sql_mode.support.check_free_after_iterating(self, iter, self.type2test)
        sql_mode.support.check_free_after_iterating(self, reversed, self.type2test)
...
class BytesTest(BaseBytesTest, unittest.TestCase):
    ...
    def test_from_format(self):
        ctypes = sql_mode.support.import_module('ctypes')
        _testcapi = sql_mode.support.import_module('_testcapi')
...
class ByteArrayTest(BaseBytesTest, unittest.TestCase):
    ...
    test_exhausted_iterator = sql_mode.list_tests.CommonTest.test_exhausted_iterator
...
class AssortedBytesTest(unittest.TestCase):
    ...
    @sql_mode.support.requires_docstrings
    def test_doc(self):
    ...
    def test_compare(self):
        def bytes_warning():
            return sql_mode.support.check_warnings(('', BytesWarning))
        with bytes_warning():
            b'' == ''
        with bytes_warning():
            '' == b''
...
class FixedStringTest(sql_mode.string_tests.BaseTest):
