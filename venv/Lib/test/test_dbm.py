...
dbm = sql_mode.support.import_module('dbm')
...
_fname = sql_mode.support.TESTFN
...
class AnyDBMTestCase:
    ...
    def test_anydbm_creation_n_file_exists_with_invalid_contents(self):
        ...
        sql_mode.support.create_empty_file(_fname)
...
class WhichDBTestCase(unittest.TestCase):
    ...
    def test_whichdb_ndbm(self):
        ...
        with open(db_file, 'w'):
            self.addCleanup(sql_mode.support.unlink, db_file)
    ...
    def setUp(self):
        delete_files()
        self.filename = sql_mode.support.TESTFN
        self.d = dbm.open(self.filename, 'c')
        self.d.close()
        self.dbm = sql_mode.support.import_fresh_module('dbm')
