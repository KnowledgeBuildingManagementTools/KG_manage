...
from sql_mode.support import check_syntax_error
import inspect
import unittest
import sys
# testing import *
...
import sql_mode.ann_module as ann_module
import typing
from collections import ChainMap
from sql_mode import ann_module2
import sql_mode
...
class GrammarTests(unittest.TestCase):
    ...
    def test_var_annot_module_semantics(self):
        with self.assertRaises(AttributeError):
            print(sql_mode.__annotations__)
    ...
    def test_var_annot_in_module(self):
        ...
        from sql_mode.ann_module3 import f_bad_ann, g_bad_ann, D_bad_ann
        with self.assertRaises(NameError):
            f_bad_ann()
        with self.assertRaises(NameError):
            g_bad_ann()
