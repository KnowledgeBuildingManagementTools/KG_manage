...
We'll simulate a __file__ attr that ends in pyc:
    ...
    >>> import sql_mode.test_doctest
    >>> old = sql_mode.test_doctest.__file__
    >>> sql_mode.test_doctest.__file__ = 'test_doctest.pyc'
...
leading path components.
    ...
    >>> sql_mode.test_doctest.__file__ = old
...
functions, classes, and the `__test__` dictionary, if it exists:
    ...
    >>> import sql_mode.test_doctest
    >>> tests = finder.find(m, module=sql_mode.test_doctest)
    >>> for t in tests:
    ...     print('%2s  %s' % (len(t.examples), t.name))
     1  some_module
...
will only be generated for it once:
    ...
    >>> from sql_mode import doctest_aliases
...
DocTestFinder finds the line number of each example:
    ...
    >>> [e.lineno for e in sql_mode.examples]
    [1, 9, 12]
"""
...
words and expected output are converted to comments:
    ...
    >>> print(doctest.testsource(sql_mode.test_doctest, name))
    # Blah blah
    #
    print(sample_func(22))
    # Expected:
...
def test_DocTestSuite():
    """DocTestSuite creates a unittest test suite from a doctest.
       ...
       by passing a module object:
         ...
         >>> import unittest
         >>> import sql_mode.sample_doctest
         >>> suite = doctest.DocTestSuite(sql_mode.sample_doctest)
       ...
       We can use the current module:
         ...
         >>> suite = sql_mode.sample_doctest.test_suite()
         >>> suite.run(unittest.TestResult())
         <unittest.result.TestResult run=9 errors=0 failures=4>
       ...
       You can supply setUp and tearDown functions:
         ...
         >>> def setUp(t):
         ...     import sql_mode.test_doctest
         ...     sql_mode.test_doctest.sillySetup = True

         >>> def tearDown(t):
         ...     import sql_mode.test_doctest
         ...     del sql_mode.test_doctest.sillySetup
       ...
       But the tearDown restores sanity:
         ...
         >>> import sql_mode.test_doctest
         >>> sql_mode.test_doctest.sillySetup
         Traceback (most recent call last):
         ...
...
def test_DocFileSuite():
    """We can test tests found in text files using a DocFileSuite.
       ...
       provided.
         ...
         >>> import unittest, pkgutil, sql_mode
         >>> added_loader = False
         >>> if not hasattr(sql_mode, '__loader__'):
         ...     sql_mode.__loader__ = pkgutil.get_loader(sql_mode)
         ...     added_loader = True
         >>> try:
         ...     suite = doctest.DocFileSuite('test_doctest.txt',
         ...                                  'test_doctest2.txt',
       ...
       are resolved relative to the directory of sys.argv[0]:
         ...
         >>> import types, os.path, sql_mode.test_doctest
         >>> save_argv = sys.argv
         >>> sys.argv = [sql_mode.test_doctest.__file__]
         >>> suite = doctest.DocFileSuite('test_doctest.txt',
       ...
       working directory):
         ...
         >>> test_doctest_path = os.path.abspath(sql_mode.test_doctest.__file__)
       ...
       test_doctest.txt:
         ...
         >>> def setUp(test):
         ...     sql_mode.globs['favorite_color'] = 'blue'
...
the verbose version, and then check the output:
    ...
    >>> from sql_mode.support import script_helper, temp_dir
...
def test_main():
    ...
    from sql_mode import test_doctest
