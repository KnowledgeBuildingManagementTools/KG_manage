import unittest, sql_mode.support
...
class SysModuleTest(unittest.TestCase):
    ...
    def test_excepthook(self):
        with sql_mode.support.captured_output("stderr") as stderr:
    ...
    def test_getwindowsversion(self):
        ...
        sql_mode.support.get_attribute(sys, "getwindowsversion")
    ...
    @sql_mode.support.refcount_test
    ...
    @unittest.skipUnless(sql_mode.support.FS_NONASCII,
    ...
    def test_ioencoding_nonascii(self):
        ...
        p = subprocess.Popen([sys.executable, "-c",
                                'print(%a)' % sql_mode.support.FS_NONASCII],
                             stdout=subprocess.PIPE, env=env)
        out = p.communicate()[0].strip()
        self.assertEqual(out, os.fsencode(sql_mode.support.FS_NONASCII))
    ...
    @sql_mode.support.requires_type_collecting
...
class SizeofTest(unittest.TestCase):
    ...
    check_sizeof = sql_mode.support.check_sizeof

    def test_gc_head_size(self):
        # Check that the gc header size is added to objects tracked by the gc.
        vsize = sql_mode.support.calcvobjsize
    ...
    def test_default(self):
        size = sql_mode.support.calcvobjsize
    ...
    def test_objecttypes(self):
        ...
        size = sql_mode.support.calcobjsize
        vsize = sql_mode.support.calcvobjsize
...
def test_main():
    sql_mode.support.run_unittest(SysModuleTest, SizeofTest)
