...
class LocaltimeTests(unittest.TestCase):
    ...
    def test_localtime_is_tz_aware_daylight_true(self):
        sql_mode.support.patch(self, time, 'daylight', True)
        t = utils.localtime()
        self.assertIsNotNone(t.tzinfo)

    def test_localtime_is_tz_aware_daylight_false(self):
        sql_mode.support.patch(self, time, 'daylight', False)
        t = utils.localtime()
        self.assertIsNotNone(t.tzinfo)
    ...
    @sql_mode.support.run_with_tz('EST+05EDT,M3.2.0,M11.1.0')
    ...
    @sql_mode.support.run_with_tz('Europe/Kiev')
...
@sql_mode.support.requires_mac_ver(10, 7)
class FormatDateTests(unittest.TestCase):

    @sql_mode.support.run_with_tz('Europe/Minsk')
