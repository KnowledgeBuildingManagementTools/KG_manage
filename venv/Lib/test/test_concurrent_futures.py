...
class FutureTests(unittest.TestCase):
    ...
    def test_done_callback_raises(self):
        with sql_mode.support.captured_stderr() as stderr:
...
def test_main():
    try:
        sql_mode.support.run_unittest(__name__)
    finally:
