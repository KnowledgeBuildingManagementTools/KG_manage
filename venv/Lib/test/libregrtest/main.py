...
import time
import unittest
from sql_mode.libregrtest.cmdline import _parse_args
from sql_mode.libregrtest.runtest import (
    findtests, runtest, get_abs_module,
    STDTESTS, NOTTESTS, PASSED, FAILED, ENV_CHANGED, SKIPPED, RESOURCE_DENIED,
    INTERRUPTED, CHILD_ERROR,
    PROGRESS_MIN_TIME, format_test_result)
from sql_mode.libregrtest.setup import setup_tests
...
class Regrtest:
    ...
    def run_tests(self):
        ...
        if self.ns.use_mp:
            from sql_mode.libregrtest.runtest_mp import run_tests_multiprocess
    ...
    def _main(self, tests, kwargs):
        ...
        if self.ns.slaveargs is not None:
            from sql_mode.libregrtest.runtest_mp import run_tests_slave
